    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="78%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">课程信息管理 &gt; 修改课程信息 &gt;&gt;&gt;</span></td>
...
<form action="<%=bp %>/lesson/modify" method="post">
  ...
  <tr align="center">
    <td width="27%" align="left" style="padding:5px;">课程名称：</td>
    ...
    <tr>
      ...
      <td>
		...
		&nbsp;
		<input type="button"  class="btn_grey" value="返回" onclick="window.location.href='/OnlineExam/lesson/refreshPage'"/>
		</td>
    </tr>
</table>
</form>
