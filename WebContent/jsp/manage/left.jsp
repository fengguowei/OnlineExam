...
<table width="100%" height="441" border="0" cellpadding="0" cellspacing="0" class="tableBorder">
  <tr>
    ...
    <img src="<%=bp %>/image/m_ico.gif" width="11" height="11" />&nbsp;</td>
    <td width="75%" align="left" class="tableBorder_B">
    <a href="<%=bp %>/manager/refreshPage" >管理员信息管理</a></td>
  </tr>
  <tr>
      <td width="25%" height="32" align="right" class="tableBorder_B">
    <img src="<%=bp %>/image/m_ico.gif" width="11" height="11" />&nbsp;</td>
    <td height="32" colspan="2" align="left" class="tableBorder_B">
    <a href="<%=bp %>/student/refreshPage">考生信息管理</a></td>
  </tr>
  <tr>
      <td width="25%" height="32" align="right" class="tableBorder_B">
    <img src="<%=bp %>/image/m_ico.gif" width="11" height="11" />&nbsp;</td>
    <td height="32" colspan="2" align="left" class="tableBorder_B">
    <a href="<%=bp %>/stuResult/refreshPage">考生成绩查询</a></td>
  </tr>
  <tr>
      <td width="25%" height="32" align="right" class="tableBorder_B">
    <img src="<%=bp %>/image/m_ico.gif" width="11" height="11" />&nbsp;</td>
    <td height="32" colspan="2" align="left" class="tableBorder_B">
    <a href="<%=bp %>/lesson/refreshPage">课程信息管理</a></td>
  </tr>
  <tr>
      <td width="25%" height="32" align="right" class="tableBorder_B">
    <img src="<%=bp %>/image/m_ico.gif" width="11" height="11" />&nbsp;</td>
    <td height="32" colspan="2" align="left" class="tableBorder_B">
    <a href="<%=bp %>/taoti/refreshPage">套题信息管理</a></td>
  </tr>
  <tr>
      <td width="25%" height="32" align="right" class="tableBorder_B">
    <img src="<%=bp %>/image/m_ico.gif" width="11" height="11" />&nbsp;</td>
    <td height="32" colspan="2" align="left" class="tableBorder_B">
    <a href="<%=bp %>/shiti/refreshPage">考试题目管理</a>
    </td>
  </tr>
  <tr>
      <td width="25%" height="32" align="right" class="tableBorder_B">
    <img src="<%=bp %>/image/m_ico.gif" width="11" height="11" />&nbsp;</td>
    <td height="32" colspan="2" align="left" class="tableBorder_B">
    <a href="<%=bp%>/jsp/manage/login.jsp">退出后台系统</a>
   </td>
  </tr>
  <tr>
