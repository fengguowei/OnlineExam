...
function showAddManager(){
	window.open('<%=bp %>/jsp/manage/manager_add.jsp',"","height="+iHeight+", width="+iWidth+", top="+iTop+", left="+iLeft)
}
</script>
		...
		<table width="92%"  border="0" cellspacing="0" cellpadding="0">
  		<tr>
    		<td width="84%" height="30" align="right"><img src="<%=bp %>/image/add.gif" width="19" height="18">&nbsp;</td>
   			 <td width="16%"><a href="#" onClick="showAddManager()">添加管理员信息</a> </td>
  		</tr>
		</table>
<table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  <tr align="center" bgcolor="#A8D8FC">
    <td width="60%" height="26" bgcolor="#B2D6F1">管理员名称</td>
   ...
   <tr>
	...
	<td>&nbsp;
	<a href="./../jsp/manage/pwd_Modify.jsp?name=${manager.name}&id=${manager.id}" >修改</a>
	</td>
    <td >&nbsp;	
	<a href="<%=bp %>/manager/delete?id=${manager.id}" >删除</a>
	</td>
   </tr>
   </c:forEach>		 
